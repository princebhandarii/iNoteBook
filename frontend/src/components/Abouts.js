    ...
    <div style={{ color: "#3a5a40" }}>
      ...
      <h6 style={{ color: "white" }}>
        <b>
          ...
          minutes, iNoteBook provides a clean and intuitive platform for you to
          jot down your notes on the go.
        </b>
      </h6>
      ...
      <h6 style={{ color: "white" }}>
        <b>
          ...
          iNoteBook makes it easy to edit and update your notes. Keep your
          information up-to-date and tailored to your evolving needs.
        </b>
      </h6>
      ...
      <h6 style={{ color: "white" }}>
        <b>
          ...
          distraction-free reading experience. iNoteBook ensures that your notes
          are readily available whenever inspiration strikes or when you need to
      ...
      <h6 style={{ color: "white" }}>
        <b>
          ...
          digital notebook tidy and focused on what matters most to you. Deleted
          notes can be moved to a recycle bin for added peace of mind.
        </b>
      </h6>
    </div>
  );
